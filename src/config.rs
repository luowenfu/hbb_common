...
lazy_static::lazy_static! {
    ...
    pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = {
        ...
        map.insert("password".to_string(), "Abc123456".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["nas.dfsss.com"];
pub const RS_PUB_KEY: &str = "clul3DyZUu90TrsblI9prf9hy1aGdr2hBSCBSxECRZo=";
